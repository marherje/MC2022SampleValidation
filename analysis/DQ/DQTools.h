  ...
  TH1F* h_stable_isr_phi[10];
  TH1F* h_stable_isr_theta[10];
  TH1F* h_stable_isr_mom[10];
  TH1F* h_stable_isr_n[10];
...
void InitHistosMC(std::vector<TString> name) {
  ...
  for(unsigned int i=0; i<name.size(); i++) {    
    ...
    h_stable_isr_phi[i] = new TH1F("stable_isr_phi_"+name.at(i),"stable_isr_phi_"+name.at(i),100,0,2.*TMath::Pi());
    h_stable_isr_theta[i] = new TH1F("stable_isr_theta_"+name.at(i),"stable_isr_theta_"+name.at(i),100,0,TMath::Pi());
    h_stable_isr_mom[i] = new TH1F("stable_isr_mom_"+name.at(i),"stable_isr_mom_"+name.at(i),251,-0.5,250.5);
    h_stable_isr_n[i] = new TH1F("stable_isr_n_"+name.at(i),"stable_isr_n_"+name.at(i),1000,-0.5,999.5);
...
void WriteHistosMC() {
  ...
  for(int i=0; i<6; i++) {
    ...
    h_stable_isr_phi[6]->Add(h_stable_isr_phi[i]);
    h_stable_isr_theta[6]->Add(h_stable_isr_theta[i]);
    h_stable_isr_mom[6]->Add(h_stable_isr_mom[i]);
    h_stable_isr_n[6]->Add(h_stable_isr_n[i]);
  ...
  for(int i=0; i<3; i++) {
    ...
    h_stable_isr_phi[7]->Add(h_stable_isr_phi[i]);
    h_stable_isr_theta[7]->Add(h_stable_isr_theta[i]);
    h_stable_isr_mom[7]->Add(h_stable_isr_mom[i]);
    h_stable_isr_n[7]->Add(h_stable_isr_n[i]);
  ...
  for(int i=3; i<6; i++) {
    ...
    h_stable_isr_phi[8]->Add(h_stable_isr_phi[i]);
    h_stable_isr_theta[8]->Add(h_stable_isr_theta[i]);
    h_stable_isr_mom[8]->Add(h_stable_isr_mom[i]);
    h_stable_isr_n[8]->Add(h_stable_isr_n[i]);
  ...
  for(int i=0; i<9; i++) {
    ...
    h_stable_isr_phi[i]->Write();
    h_stable_isr_theta[i]->Write();
    h_stable_isr_mom[i]->Write();
    h_stable_isr_n[i]->Write();
