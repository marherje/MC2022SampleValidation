...
#include "cross_sections_500GeV.h"
...
void Labels(int i, TString pol, TString kvalue){
 ...
 if(i==9) {
  ...
  if(pol=="eL_pR")QQBARLabel2(0.3,0.97, "e_{L}^{-}e_{R}^{+} #rightarrow q#bar{q}, q=udscb, 500 GeV, 46.4 fb^{-1}",kGray+2);
  if(pol=="eR_pL")QQBARLabel2(0.3,0.97, "e_{R}^{-}e_{L}^{+} #rightarrow q#bar{q}, q=udscb, 500 GeV, 47.0 fb^{-1}",kGray+2);
...
// ------------------------------------------------------------
// ------------------------------------------------------------
void analysis500GeV(int cut, TString pol, TString kvalue) {
    ...
    //TString filename = folder+"selection_cuts0_"+"qqbar_NEW_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    TString filename = folder+pol+"/0/100/50/"+"selection_cuts0_"+"qqbar_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    //TString filename = folder+"eL/0/100/50/selection_cuts0_"+"2f_hadronic_sample_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    ...
    TString filenamecut = folder+pol+"/0/100/50/"+cutname+"qqbar_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    //TString filenamecut = folder+cutname+"qqbar_NEW_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    //TString filenamecut = folder+"eL/0/100/50/"+cutname+"2f_hadronic_sample_"+pol+"_Kgamma"+kvalue+"_500GeV.root";
    ...
    */
    ...
    canvascostheta_ratio->SaveAs("efficiency_"+cutstring+"_"+pol+"_old.png");    
    ...
    cout << "bb " << "cc " << "qq " << "radreturn WW ZZ tt" << endl;
    cout << bb_ef_total << " " <<  cc_ef_total << " " << qq_ef_total << " " << radreturn_ef_total<< " " << WW_ef_total << " " << ZZ_ef_total << " " << TT_ef_total  << "|" << endl;
    cout << bb_ef_total_L << " " <<  cc_ef_total_L << " " << qq_ef_total_L << " " << radreturn_ef_total_L << " " << WW_ef_total_L << " " << ZZ_ef_total_L << " " << TT_ef_total << "||" << endl;
