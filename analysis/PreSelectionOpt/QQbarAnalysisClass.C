...
void QQbarAnalysisClass::JetTag(int n_entries=-1, int selection_type=0, float Kvcut=30)
{
...
void QQbarAnalysisClass::Selection(int n_entries=-1, int selection_type=0, float Kvcut=30, int bkg=0)
{
